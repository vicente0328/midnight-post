          ...
          >
            ...
            <div className="px-8 py-8">
              ...
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h2 className="font-serif text-xl tracking-wide">
                    {mode === 'reset' ? t('auth.resetTitle') : mode === 'login' ? t('auth.loginTitle') : t('auth.signupTitle')}
                  </h2>
              ...
              {mode !== 'reset' && (
                <>
                  ...
                  <div className="flex items-center gap-3 my-5">
                    ...
                    <span className="text-xs opacity-30 font-serif italic">{t('auth.or')}</span>
                    <div className="flex-1 h-px bg-ink/10" />
                  </div>
                </>
              )}
              ...
              <form onSubmit={mode === 'reset' ? handleReset : handleEmailSubmit} className="space-y-3">
                ...
                {resetSent && (
                  <p className="text-green-700/70 text-xs italic">{t('auth.resetSent')}</p>
                )}
