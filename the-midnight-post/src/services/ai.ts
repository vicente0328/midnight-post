...
2. 편지 본문 (advice): 아래 세 흐름을 자연스럽게 이어주세요.
   ...
   - 연결: 그 이야기의 의미를 사용자의 일기와 다정하게 이어주세요. 설명하지 말고, 깊이 공감하듯 말해주세요. 사용자가 느끼는 감정을 먼저 충분히 인정하고, 그 마음이 얼마나 소중한지 담아주세요.
   - 마무리: 한 줄의 여운. 가르치려 하지 말고, 곁에 앉아 있는 사람처럼 — 마치 기도나 축복을 건네듯 — 따뜻하게 마무리하세요. 사용자가 오늘 밤 조금 더 안심하고 잠들 수 있도록.
